...
RAG, text-to-SQL, LLM routing, QLoRA fine-tuning, knowledge graphs, LangChain / LangGraph, tool orchestration.

**Evaluation:** golden datasets, LLM-as-judge, faithfulness & instruction-following metrics, model A/B comparison.
...
Docker, MLflow, Optuna, Git/GitHub workflows, ONNX & TFLite export, quantization, pruning, Flask/React/Streamlit serving.
